...
{
  address: { city: 'man', street: 's', building: 1 },
  _id: 5,
  email: 'alaa4@gmail.com',
  name: 'alaa',
  password: '$2b$15$2wTYpVQwJYKXNuF7rNRRre4otU5O0hek9h4z6tdOjEI.dizbdvDE2',
  report: [],
  __v: 0
}
...
ReportContentModel.find({})
.populate("type_id")
.then((data) => {
  // if(req.user._id == data.account){
    // return res.status(200).json({ message: "Reports", data });
  // }
  // console.log(data)
  data.map((d) => {
